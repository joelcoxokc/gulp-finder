;(function(){
  ...
  /**
   * Finder
   * @description  Finder is designed to recursively traverse the given root path,
   ...
   */
    ...
    Finder = module.exports = Finder;

      function Finder(rootDir){
      ...
      function setPaths(rootDirs, base, obj){
        ...
        function buildParrent(){
          _(rootDirs).forEach(function (root){
            if(root !== 'node_modules' && root !== 'bower_components' && root !== '.git' ){
